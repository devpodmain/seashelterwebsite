<header class="site-navbar py-3 js-site-navbar site-navbar-target navbar-light bg-light" role="banner" id="site-navbar">

<div class="container">
  <div class="row align-items-center">
    
    <div class="col-11 col-xl-3 site-logo navbar navbar-light bg-light">

      <h1 class="mb-0">
      <a href="index.html" class="text-white h3 mb-0">
      ...
      <nav class="site-navigation position-relative text-right" role="navigation">
        ...
        <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
          ...
          <li class="has-children">
            ...
            <ul class="dropdown">
              <li><a href="#section-how-it-works" class="nav-link">Warehouse Pvt Ltd</a></li>
              <li><a href="#section-our-team" class="nav-link">Carrier Pvt Ltd</a></li>
            </ul>
          </li>
